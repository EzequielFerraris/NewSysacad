namespace NewSysacadFront
{
    partial class FrmHomeAdministrador
    {
        ...
        {
            panel1 = new Panel();
            pnlSubMenuProfes = new Panel();
            btnAgregarProfesor = new Button();
            btnGestionarProfesores = new Button();
            ...
            pnlSubMenuProfes.SuspendLayout();
            ...
            panel1.Controls.Add(pnlSubMenuProfes);
            panel1.Controls.Add(btnGestionarProfesores);
            ...
            // pnlSubMenuProfes
            // 
            pnlSubMenuProfes.BackColor = Color.FromArgb(158, 153, 186);
            pnlSubMenuProfes.Controls.Add(btnAgregarProfesor);
            pnlSubMenuProfes.Dock = DockStyle.Top;
            pnlSubMenuProfes.Location = new Point(0, 374);
            pnlSubMenuProfes.Name = "pnlSubMenuProfes";
            pnlSubMenuProfes.Size = new Size(200, 30);
            pnlSubMenuProfes.TabIndex = 10;
            // 
            // btnAgregarProfesor
            // 
            btnAgregarProfesor.Dock = DockStyle.Fill;
            btnAgregarProfesor.FlatAppearance.BorderSize = 0;
            btnAgregarProfesor.FlatAppearance.MouseDownBackColor = Color.Coral;
            btnAgregarProfesor.FlatAppearance.MouseOverBackColor = Color.FromArgb(125, 121, 163);
            btnAgregarProfesor.FlatStyle = FlatStyle.Flat;
            btnAgregarProfesor.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point);
            btnAgregarProfesor.ForeColor = Color.DarkRed;
            btnAgregarProfesor.Location = new Point(0, 0);
            btnAgregarProfesor.Name = "btnAgregarProfesor";
            btnAgregarProfesor.Padding = new Padding(10, 0, 0, 0);
            btnAgregarProfesor.Size = new Size(200, 30);
            btnAgregarProfesor.TabIndex = 0;
            btnAgregarProfesor.Text = "Agregar Profesor";
            btnAgregarProfesor.TextAlign = ContentAlignment.MiddleLeft;
            btnAgregarProfesor.UseVisualStyleBackColor = true;
            btnAgregarProfesor.Click += btnAgregarProfesor_Click;
            // 
            // btnGestionarProfesores
            // 
            btnGestionarProfesores.Dock = DockStyle.Top;
            btnGestionarProfesores.FlatAppearance.BorderSize = 0;
            btnGestionarProfesores.FlatAppearance.MouseDownBackColor = Color.Coral;
            btnGestionarProfesores.FlatAppearance.MouseOverBackColor = Color.FromArgb(125, 121, 163);
            btnGestionarProfesores.FlatStyle = FlatStyle.Flat;
            btnGestionarProfesores.Font = new Font("Segoe UI", 9.75F, FontStyle.Bold, GraphicsUnit.Point);
            btnGestionarProfesores.ForeColor = Color.DarkRed;
            btnGestionarProfesores.Location = new Point(0, 327);
            btnGestionarProfesores.Name = "btnGestionarProfesores";
            btnGestionarProfesores.Padding = new Padding(10, 0, 0, 0);
            btnGestionarProfesores.Size = new Size(200, 47);
            btnGestionarProfesores.TabIndex = 9;
            btnGestionarProfesores.Text = "Gestionar Perfiles Profesores";
            btnGestionarProfesores.TextAlign = ContentAlignment.MiddleLeft;
            btnGestionarProfesores.UseVisualStyleBackColor = true;
            btnGestionarProfesores.Click += btnGestionarProfesores_Click;
            // 
            ...
            btnGenerarNotificacion.Location = new Point(0, 297);
            btnGenerarNotificacion.Name = "btnGenerarNotificacion";
            btnGenerarNotificacion.Padding = new Padding(10, 0, 0, 0);
            btnGenerarNotificacion.Size = new Size(200, 30);
            btnGenerarNotificacion.TabIndex = 8;
            btnGenerarNotificacion.Text = "Nueva Notificación";
            btnGenerarNotificacion.TextAlign = ContentAlignment.MiddleLeft;
            ...
            btnListasEspera.Location = new Point(0, 267);
            btnListasEspera.Name = "btnListasEspera";
            btnListasEspera.Padding = new Padding(10, 0, 0, 0);
            btnListasEspera.Size = new Size(200, 30);
            btnListasEspera.TabIndex = 7;
            btnListasEspera.Text = "Manejar Listas de Espera";
            btnListasEspera.TextAlign = ContentAlignment.MiddleLeft;
            ...
            btnRequisitosAcademicos.Location = new Point(0, 220);
            btnRequisitosAcademicos.Name = "btnRequisitosAcademicos";
            btnRequisitosAcademicos.Padding = new Padding(10, 0, 0, 0);
            btnRequisitosAcademicos.Size = new Size(200, 47);
            btnRequisitosAcademicos.TabIndex = 6;
            btnRequisitosAcademicos.Text = "Gestionar Requisitos Académicos";
            btnRequisitosAcademicos.TextAlign = ContentAlignment.MiddleLeft;
            ...
            btnReportes.Location = new Point(0, 190);
            btnReportes.Name = "btnReportes";
            btnReportes.Padding = new Padding(10, 0, 0, 0);
            btnReportes.Size = new Size(200, 30);
            ...
            pnlSubMenuGE.Location = new Point(0, 160);
            pnlSubMenuGE.Name = "pnlSubMenuGE";
            pnlSubMenuGE.Size = new Size(200, 30);
            ...
            btnAgregarCurso.Padding = new Padding(10, 0, 0, 0);
            btnAgregarCurso.Size = new Size(200, 30);
            btnAgregarCurso.TabIndex = 0;
            btnAgregarCurso.Text = "Agregar curso";
            btnAgregarCurso.TextAlign = ContentAlignment.MiddleLeft;
            ...
            btnGestionarCursos.Location = new Point(0, 130);
            btnGestionarCursos.Name = "btnGestionarCursos";
            btnGestionarCursos.Padding = new Padding(10, 0, 0, 0);
            btnGestionarCursos.Size = new Size(200, 30);
            btnGestionarCursos.TabIndex = 2;
            btnGestionarCursos.Text = "Gestionar Cursos";
            btnGestionarCursos.TextAlign = ContentAlignment.MiddleLeft;
            ...
            btnAgregarEstudiante.Padding = new Padding(10, 0, 0, 0);
            btnAgregarEstudiante.Size = new Size(200, 30);
            btnAgregarEstudiante.TabIndex = 1;
            btnAgregarEstudiante.Text = "Agregar Estudiante";
            btnAgregarEstudiante.TextAlign = ContentAlignment.MiddleLeft;
            ...
            pnlSubMenuProfes.ResumeLayout(false);
        ...
        private Button btnGestionarProfesores;
        private Panel pnlSubMenuProfes;
