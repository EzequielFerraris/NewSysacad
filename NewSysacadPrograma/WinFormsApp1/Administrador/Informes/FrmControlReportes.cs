...
namespace NewSysacadFront
{
    public partial class FrmControlReportes : Form
    {
        ...
        public FrmControlReportes(Administrador admin)
        {
            ...
            inscripcionesPeriodo = new FrmInformeInscripcionesPorPeriodo(admin);
