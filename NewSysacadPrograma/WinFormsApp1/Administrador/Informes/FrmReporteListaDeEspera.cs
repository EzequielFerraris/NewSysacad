...
{
    public partial class FrmReporteListaDeEspera : Form
    {
        private Administrador admin;
        public FrmReporteListaDeEspera(Curso curso, Administrador admin)
        {
            InitializeComponent();
            this.admin = admin;
        ...
        private void btnDescargarPDF_Click(object sender, EventArgs e)
        {
            ...
            guardar.FileName = DateTime.Now.ToString("dd-MM-yyyy") + "inscriptosListaEspera" + ".pdf";
